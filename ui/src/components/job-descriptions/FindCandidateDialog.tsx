...
export function FindCandidateDialog({ open, onOpenChange, jobDescription }: FindCandidateDialogProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl max-h-[80vh]">
        <DialogHeader>
          ...
          <DialogDescription>
            {jobDescription ? `Top matches for ${jobDescription.name}` : 'Top candidate matches'}
          </DialogDescription>
        </DialogHeader>
